#ifndef VTKA0PacketInterpreter_h
#define VTKA0PacketInterpreter_h
...
#include "A0PacketFormat.h"

#include <memory>

#define USING_ANGLE_MODEL        1
#define USING_RT_MATRIX          0
...
class VTK_EXPORT vtkA0PacketInterpreter : public vtkLidarPacketInterpreter
{
    enum {
        VECTOR_SIZE = 3,
        ANGLE_SIZE = 6
...
public:
  static vtkA0PacketInterpreter* New();
  vtkTypeMacro(vtkA0PacketInterpreter, vtkLidarPacketInterpreter)
...
protected:
  ...
  vtkA0PacketInterpreter();
  ~vtkA0PacketInterpreter();

private:
  vtkA0PacketInterpreter(const vtkA0PacketInterpreter&) = delete;
  void operator=(const vtkA0PacketInterpreter&) = delete;
...
#endif // VTKA0PacketInterpreter_h
