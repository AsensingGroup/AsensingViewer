...
#else
  std::vector<vtkSmartPointer<vtkPolyData> > vecFrames = this->GetLidarInterpreter()->GetAllFramesAvailable();
  for( auto it = vecFrames.begin(); it != vecFrames.end(); it++)
  {
        this->Frames.push_back(*it);
  }
