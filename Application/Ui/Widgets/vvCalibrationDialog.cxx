...
public:
    ...
    : Settings(pqApplicationCore::instance()->settings())
  {
    ...
    const char* filenames[nFile] = {
      ...
      "A0-Correction.json", "A0-Correction-5.json", "A2-Correction.json"  // Asensing Calibration
    };
    ...
    qDebug() << "Calibration Files: " << BuiltInCalibrationFiles;
  }
  ...
  , Internal(new pqInternal)
{
  ...
  liveCalibrationItem->setText("Default Corrections (unused)");
...
void vvCalibrationDialog::setDefaultConfiguration()
{
  ...
  const int defaultLidarPort = 51180; // The port between 0 and 1023 are reserved, e.g 2368
