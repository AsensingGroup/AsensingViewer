...
void vvMainWindow::setupGUICustom()
{
  ...
  // Windows defender
  connect(this->Internals->actionOpen_Windows_Defender, &QAction::triggered, this, [=]() {
    system("control firewall.cpl");
  });

#ifndef WIN32
  this->Internals->actionOpen_Windows_Defender->setVisible(false);
#endif
