...
void DifopMonitor::updateUI(const DeviceInfoPackage *p)
{
    ...
    ui->horizontalStartAngle->setText(QString("%1°").arg((int)p->difPackageHead.fovCfgInfo.startAngleH * 0.01-360));
    ui->horizontalEndAngle->setText(QString("%1°").arg((int)p->difPackageHead.fovCfgInfo.endAngleH * 0.01));
    ui->verticalStartAngle->setText(QString("%1°").arg((int)p->difPackageHead.fovCfgInfo.startAngleV * 0.01-360));
    ui->verticalEndAngle->setText(QString("%1°").arg((int)p->difPackageHead.fovCfgInfo.endAngleV * 0.01));
    ...
    ui->alarmCount->setText(QString("%1").arg((int)row));
}
